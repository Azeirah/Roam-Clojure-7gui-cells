...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_12171);
...
var len__4736__auto___12175 = arguments.length;
var i__4737__auto___12176 = (0);
while(true){
if((i__4737__auto___12176 < len__4736__auto___12175)){
args__4742__auto__.push((arguments[i__4737__auto___12176]));

var G__12177 = (i__4737__auto___12176 + (1));
i__4737__auto___12176 = G__12177;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq12172){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12173,G__12174,seq12172__$2);
}));
...
var vec__12178 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__12178,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__12178,(1),null);
var G__12181 = cljs.core.PersistentArrayMap.EMPTY;
var G__12181__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__12181,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12181);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__12181__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__12181__$1;
}
} else {
...
return (function() { 
var G__12185__delegate = function (klass,contents){
var vec__12182 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__12182,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__12182,(1),null);
...
var G__12185 = function (klass,var_args){
var contents = null;
...
while (G__12186__i < G__12186__a.length) {G__12186__a[G__12186__i] = arguments[G__12186__i + 1]; ++G__12186__i;}
  contents = new cljs.core.IndexedSeq(G__12186__a,0,null);
} 
return G__12185__delegate.call(this,klass,contents);};
G__12185.cljs$lang$maxFixedArity = 1;
G__12185.cljs$lang$applyTo = (function (arglist__12187){
var klass = cljs.core.first(arglist__12187);
var contents = cljs.core.rest(arglist__12187);
return G__12185__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__12191){
...
var ns = cljs.core.get.call(null,map__12192__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__12192__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__12194){
...
var actual = cljs.core.get.call(null,map__12195__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__12195__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__12197){
var map__12198 = p__12197;
...
var expected = cljs.core.get.call(null,map__12198__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__12198__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__12200_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__12200_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__12202 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__12202__$1;
var name = cljs.core.get.call(null,map__12202__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__12202__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__12202__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__12201_SHARP_){
return cljs.core.cons.call(null,node,p1__12201_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__12204){
...
var m = map__12205__$1;
var fail = cljs.core.get.call(null,map__12205__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__12205__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__12205__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__12205__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___12207 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12207)){
var message_12208 = temp__5720__auto___12207;
cljs.core.println.call(null,message_12208);
} else {
}
...
var temp__5720__auto___12209 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12209)){
var message_12210 = temp__5720__auto___12209;
cljs.core.println.call(null,message_12210);
} else {
}
