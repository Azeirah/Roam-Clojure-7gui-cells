...
return cljs.core.map.call(null,(function (p1__12146_SHARP_){
return html_coll.item(p1__12146_SHARP_);
...
return cljs.core.some.call(null,(function (p1__12147_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__12147_SHARP_);
...
var ctx_12148 = cvs.getContext("2d");
(ctx_12148.fillStyle = color);

ctx_12148.fillRect((0),(0),size,size);
