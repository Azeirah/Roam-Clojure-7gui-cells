...
var G__11972 = o;
goog.object.set(G__11972,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__11973__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__11973 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__11974__i = 0, G__11974__a = new Array(arguments.length -  0);
while (G__11974__i < G__11974__a.length) {G__11974__a[G__11974__i] = arguments[G__11974__i + 0]; ++G__11974__i;}
  args = new cljs.core.IndexedSeq(G__11974__a,0,null);
} 
return G__11973__delegate.call(this,args);};
G__11973.cljs$lang$maxFixedArity = 0;
G__11973.cljs$lang$applyTo = (function (arglist__11975){
var args = cljs.core.seq(arglist__11975);
return G__11973__delegate(args);
});
...
var G__11976 = o;
goog.object.set(G__11976,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__11978__i < G__11978__a.length) {G__11978__a[G__11978__i] = arguments[G__11978__i + 0]; ++G__11978__i;}
  args = new cljs.core.IndexedSeq(G__11978__a,0,null);
} 
...
var G__11980 = props;
var G__11980__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__11980,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11980);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11980__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__11980__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__11981 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11981,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__11981;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__11982){
var map__11983 = p__11982;
var map__11983__$1 = (((((!((map__11983 == null))))?(((((map__11983.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11983.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11983):map__11983);
var on_write = cljs.core.get.call(null,map__11983__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__11985_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11985_SHARP_);
}));
} else {
return null;
}
...
var vec__11988 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11988,(0),null);
var id = cljs.core.nth.call(null,vec__11988,(1),null);
var className = cljs.core.nth.call(null,vec__11988,(2),null);
...
var temp__5724__auto___11992 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___11992 == null)){
} else {
var key_11993 = temp__5724__auto___11992;
(jsprops.key = key_11993);
}
...
var temp__5724__auto___11994 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___11994 == null)){
} else {
var key_11995 = temp__5724__auto___11994;
(jsprops.key = key_11995);
}
...
var temp__5724__auto___11996 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___11996 == null)){
} else {
var key_11997 = temp__5724__auto___11996;
(jsprops.key = key_11997);
}
...
var G__11999 = n;
if(cljs.core._EQ_.call(null,"",G__11999)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__11999)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12000){
var G__12001 = cljs.core.first.call(null,seq12000);
var seq12000__$1 = cljs.core.next.call(null,seq12000);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12001,seq12000__$1);
}));
...
break;
default:
var G__12007 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__12007;
continue;
...
var ctx = ({});
var vec__12009 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__12009,(0),null);
var derefed = cljs.core.nth.call(null,vec__12009,(1),null);
...
var G__12012 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12012) {
case (0):
