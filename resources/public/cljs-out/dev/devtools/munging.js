...
var temp__5718__auto____$1 = (o13147["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13148 = temp__5718__auto____$1;
return (o13148["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12996__auto__ = f;
return (o__12996__auto__["toString"]).call(o__12996__auto__);
} else {
return "";
}
}catch (e13149){var _ = e13149;
return "";
}});
...
try{var o__12996__auto___13151 = t;
(o__12996__auto___13151["cljs$lang$ctorPrWriter"]).call(o__12996__auto___13151,t,writer);
}catch (e13150){var __13152 = e13150;
}
...
var char_code = (function (){var o__12996__auto__ = (new String(char$));
return (o__12996__auto__["charCodeAt"]).call(o__12996__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12996__auto__ = String;
return (o__12996__auto__["fromCharCode"]).call(o__12996__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13153 = num_code;
switch (G__13153) {
case (1):
return (185);
...
var o__12996__auto__ = String;
return (o__12996__auto__["fromCharCode"]).call(o__12996__auto__,superscript_code);
});
/**
...
}catch (e13155){var _e__13003__auto__ = e13155;
return false;
}})())){
...
var vec__13156 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13156,(0),null);
...
var temp__5718__auto____$1 = (o13159["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13160 = temp__5718__auto____$1;
return (o13160["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13163){
var vec__13164 = p__13163;
var ns_detector = cljs.core.nth.call(null,vec__13164,(0),null);
...
var G__13170 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13171 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13170;
remaining_tokens = G__13171;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13161){
var G__13162 = cljs.core.first.call(null,seq13161);
var seq13161__$1 = cljs.core.next.call(null,seq13161);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13162,seq13161__$1);
}));
...
var vec__13175 = cljs.core.split_with.call(null,(function (p1__13174_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13174_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13175,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13175,(1),null);
...
var vec__13181 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13181,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13181,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13184 = cljs.core.rest.call(null,remaining_tokens);
var G__13185 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13184;
name_tokens = G__13185;
continue;
} else {
...
var vec__13188 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13188,(0),null);
var arity = cljs.core.nth.call(null,vec__13188,(1),null);
var vec__13191 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13191,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13191,(1),null);
var vec__13194 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13194,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13194,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13194,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13194,(3),null);
...
var vec__13200 = result;
var munged_ns = cljs.core.nth.call(null,vec__13200,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13200,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13200,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13200,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13200,(4),null);
var arity = cljs.core.nth.call(null,vec__13200,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__13204 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__13204,(0),null);
var args = cljs.core.nth.call(null,vec__13204,(1),null);
var vec__13207 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__13207,(0),null);
var name = cljs.core.nth.call(null,vec__13207,(1),null);
...
var G__13210 = (arity + (1));
var G__13211 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13212){
var vec__13213 = p__13212;
var arity = cljs.core.nth.call(null,vec__13213,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13213,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13216_SHARP_){
return cljs.core.get.call(null,arities,p1__13216_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__13217_SHARP_){
return cljs.core.drop.call(null,(2),p1__13217_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___13224 = arguments.length;
var i__4737__auto___13225 = (0);
while(true){
if((i__4737__auto___13225 < len__4736__auto___13224)){
args__4742__auto__.push((arguments[i__4737__auto___13225]));

var G__13226 = (i__4737__auto___13225 + (1));
i__4737__auto___13225 = G__13226;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13220){
var vec__13221 = p__13220;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13221,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13218){
var G__13219 = cljs.core.first.call(null,seq13218);
var seq13218__$1 = cljs.core.next.call(null,seq13218);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13219,seq13218__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__13229__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13229__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13229__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13229__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13230 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13230,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13230,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13230,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13230,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13230,(4),null);
var arity = cljs.core.nth.call(null,vec__13230,(5),null);
...
var o__12996__auto__ = f;
return (o__12996__auto__["getBasis"]).call(o__12996__auto__);
});
/**
...
}catch (e13234){var _e__13003__auto__ = e13234;
...
var G__13235 = (obj[cljs.core.first.call(null,path)]);
var G__13236 = cljs.core.rest.call(null,path);
obj = G__13235;
path = G__13236;
continue;
} else {
...
var _STAR_ = (function (accum,p__13237){
var vec__13238 = p__13237;
var bit = cljs.core.nth.call(null,vec__13238,(0),null);
var protocol = cljs.core.nth.call(null,vec__13238,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13241){
var vec__13242 = p__13241;
var ns = cljs.core.nth.call(null,vec__13242,(0),null);
var name = cljs.core.nth.call(null,vec__13242,(1),null);
var selector = cljs.core.nth.call(null,vec__13242,(2),null);
...
var post_process = (function (p__13246){
var vec__13247 = p__13246;
var munged_name = cljs.core.nth.call(null,vec__13247,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13247,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13245_SHARP_){
return (obj[cljs.core.first.call(null,p1__13245_SHARP_)]);
}),sorted_matches);
