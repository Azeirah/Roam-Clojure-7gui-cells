...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13278){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13279,G__13280,seq13278__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13284_SHARP_){
return (!((cljs.core.meta.call(null,p1__13284_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__13285__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13289){var _e__13003__auto__ = e13289;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e13291){var _e__13003__auto__ = e13291;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13293 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13294 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13294);

try{var map__13295 = opts;
var map__13295__$1 = (((((!((map__13295 == null))))?(((((map__13295.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13295.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13295):map__13295);
var markup_db = cljs.core.get.call(null,map__13295__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13293);
}});
...
var temp__5718__auto___13300 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___13300)){
var managed_print_level_13301 = temp__5718__auto___13300;
var _STAR_print_level_STAR__orig_val__13298_13302 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13299_13303 = managed_print_level_13301;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13299_13303);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__13297_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__13297_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13298_13302);
}} else {
job_fn.call(null);
}
