...
var G__13252 = devtools.prefs.pref.call(null,v);
v = G__13252;
continue;
} else {
return v;
...
}catch (e13255){var _e__13003__auto__ = e13255;
return false;
}})();
...
}catch (e13259){var _e__13003__auto__ = e13259;
return false;
}})();
...
}catch (e13261){var _e__13003__auto__ = e13261;
return false;
}}
}
});
...
var vec__13263 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13263,(0),null);
var name = cljs.core.nth.call(null,vec__13263,(1),null);
...
return cljs.core.some.call(null,(function (p1__13266_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13266_SHARP_);
}),template);
});
