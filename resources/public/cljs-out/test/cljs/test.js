...
var G__11330 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11330,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11330;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11332){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11333,G__11334,seq11332__$2);
}));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11338_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11338_SHARP_));
...
var temp__5720__auto___11341 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11341)){
var message_11342 = temp__5720__auto___11341;
cljs.core.println.call(null,message_11342);
} else {
}
...
var temp__5720__auto___11343 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11343)){
var message_11344 = temp__5720__auto___11343;
cljs.core.println.call(null,message_11344);
} else {
}
...
var output_dir__$1 = (function (){var G__11345 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11345,"/"].join('');
} else {
return G__11345;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11347 = exception.stack;
var G__11347__$1 = (((G__11347 == null))?null:clojure.string.split_lines.call(null,G__11347));
var G__11347__$2 = (((G__11347__$1 == null))?null:cljs.core.get.call(null,G__11347__$1,depth));
if((G__11347__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11347__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11348 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11348,(0),null);
var column = cljs.core.nth.call(null,vec__11348,(1),null);
var vec__11351 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11351,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11351,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11351,(2),null);
...
var m__$1 = (function (){var G__11354 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11358 = (function (){var G__11357 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11357);
} else {
return G__11357;
}
})();
...
return cljs.core.vary_meta.call(null,G__11359,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e11360){var e = e11360;
var G__11361 = e;
var G__11361__$1 = (((G__11361 instanceof cljs.core.Keyword))?G__11361.fqn:null);
switch (G__11361__$1) {
...
var vec__11363 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11363,(0),null);
var types = vec__11363;
...
return cljs.core.map.call(null,(function (p__11366){
var vec__11367 = p__11366;
var ns = cljs.core.nth.call(null,vec__11367,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11367,(1),null);
return (function (){
...
var G__11370 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__11371 = cljs.core.seq.call(null,vars__$1);
var chunk__11372 = null;
var count__11373 = (0);
var i__11374 = (0);
while(true){
if((i__11374 < count__11373)){
var v = cljs.core._nth.call(null,chunk__11372,i__11374);
var temp__5720__auto___11376 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11376)){
var t_11377 = temp__5720__auto___11376;
each_fixture_fn.call(null,((function (seq__11371,chunk__11372,count__11373,i__11374,t_11377,temp__5720__auto___11376,v,each_fixture_fn,G__11370,G__11370__$1,env,once_fixtures,each_fixtures,vec__11367,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11377)));
});})(seq__11371,chunk__11372,count__11373,i__11374,t_11377,temp__5720__auto___11376,v,each_fixture_fn,G__11370,G__11370__$1,env,once_fixtures,each_fixtures,vec__11367,ns,vars__$1))
);
} else {
}


var G__11378 = seq__11371;
var G__11379 = chunk__11372;
var G__11380 = count__11373;
var G__11381 = (i__11374 + (1));
seq__11371 = G__11378;
chunk__11372 = G__11379;
count__11373 = G__11380;
i__11374 = G__11381;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11371);
if(temp__5720__auto__){
var seq__11371__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11371__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11371__$1);
var G__11382 = cljs.core.chunk_rest.call(null,seq__11371__$1);
var G__11383 = c__4556__auto__;
var G__11384 = cljs.core.count.call(null,c__4556__auto__);
var G__11385 = (0);
seq__11371 = G__11382;
chunk__11372 = G__11383;
count__11373 = G__11384;
i__11374 = G__11385;
continue;
} else {
var v = cljs.core.first.call(null,seq__11371__$1);
var temp__5720__auto___11386__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11386__$1)){
var t_11387 = temp__5720__auto___11386__$1;
each_fixture_fn.call(null,((function (seq__11371,chunk__11372,count__11373,i__11374,t_11387,temp__5720__auto___11386__$1,v,seq__11371__$1,temp__5720__auto__,each_fixture_fn,G__11370,G__11370__$1,env,once_fixtures,each_fixtures,vec__11367,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11387)));
});})(seq__11371,chunk__11372,count__11373,i__11374,t_11387,temp__5720__auto___11386__$1,v,seq__11371__$1,temp__5720__auto__,each_fixture_fn,G__11370,G__11370__$1,env,once_fixtures,each_fixtures,vec__11367,ns,vars__$1))
);
} else {
}


var G__11388 = cljs.core.next.call(null,seq__11371__$1);
var G__11389 = null;
var G__11390 = (0);
var G__11391 = (0);
seq__11371 = G__11388;
chunk__11372 = G__11389;
count__11373 = G__11390;
i__11374 = G__11391;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11370__$1)].join('')));
