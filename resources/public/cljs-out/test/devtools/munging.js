...
var o12604 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12604["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12605 = temp__5718__auto____$1;
return (o12605["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12453__auto__ = f;
return (o__12453__auto__["toString"]).call(o__12453__auto__);
} else {
return "";
}
}catch (e12606){var _ = e12606;
return "";
}});
...
try{var o__12453__auto___12608 = t;
(o__12453__auto___12608["cljs$lang$ctorPrWriter"]).call(o__12453__auto___12608,t,writer);
}catch (e12607){var __12609 = e12607;
}
...
var char_code = (function (){var o__12453__auto__ = (new String(char$));
return (o__12453__auto__["charCodeAt"]).call(o__12453__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12453__auto__ = String;
return (o__12453__auto__["fromCharCode"]).call(o__12453__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12610 = num_code;
switch (G__12610) {
case (1):
return (185);
...
var o__12453__auto__ = String;
return (o__12453__auto__["fromCharCode"]).call(o__12453__auto__,superscript_code);
});
/**
...
}catch (e12612){var _e__12460__auto__ = e12612;
return false;
}})())){
...
var vec__12613 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12613,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o12616 = temp__5718__auto__;
var temp__5718__auto____$1 = (o12616["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o12617 = temp__5718__auto____$1;
return (o12617["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12620){
var vec__12621 = p__12620;
var ns_detector = cljs.core.nth.call(null,vec__12621,(0),null);
...
var G__12627 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12628 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12627;
remaining_tokens = G__12628;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12618){
var G__12619 = cljs.core.first.call(null,seq12618);
var seq12618__$1 = cljs.core.next.call(null,seq12618);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12619,seq12618__$1);
}));
...
var vec__12632 = cljs.core.split_with.call(null,(function (p1__12631_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12631_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12632,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12632,(1),null);
...
var vec__12638 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12638,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12638,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12641 = cljs.core.rest.call(null,remaining_tokens);
var G__12642 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12641;
name_tokens = G__12642;
continue;
} else {
...
var vec__12645 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12645,(0),null);
var arity = cljs.core.nth.call(null,vec__12645,(1),null);
var vec__12648 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12648,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12648,(1),null);
var vec__12651 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12651,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12651,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12651,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12651,(3),null);
...
var vec__12657 = result;
var munged_ns = cljs.core.nth.call(null,vec__12657,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12657,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12657,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12657,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12657,(4),null);
var arity = cljs.core.nth.call(null,vec__12657,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__12661 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__12661,(0),null);
var args = cljs.core.nth.call(null,vec__12661,(1),null);
var vec__12664 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12664,(0),null);
var name = cljs.core.nth.call(null,vec__12664,(1),null);
...
var G__12667 = (arity + (1));
var G__12668 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12669){
var vec__12670 = p__12669;
var arity = cljs.core.nth.call(null,vec__12670,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12670,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12673_SHARP_){
return cljs.core.get.call(null,arities,p1__12673_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__12674_SHARP_){
return cljs.core.drop.call(null,(2),p1__12674_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___12681 = arguments.length;
var i__4737__auto___12682 = (0);
while(true){
if((i__4737__auto___12682 < len__4736__auto___12681)){
args__4742__auto__.push((arguments[i__4737__auto___12682]));

var G__12683 = (i__4737__auto___12682 + (1));
i__4737__auto___12682 = G__12683;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12677){
var vec__12678 = p__12677;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12678,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12675){
var G__12676 = cljs.core.first.call(null,seq12675);
var seq12675__$1 = cljs.core.next.call(null,seq12675);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12676,seq12675__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__12686__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12686__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12686__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12686__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12687 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12687,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12687,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12687,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12687,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12687,(4),null);
var arity = cljs.core.nth.call(null,vec__12687,(5),null);
...
var o__12453__auto__ = f;
return (o__12453__auto__["getBasis"]).call(o__12453__auto__);
});
/**
...
}catch (e12691){var _e__12460__auto__ = e12691;
...
var G__12692 = (obj[cljs.core.first.call(null,path)]);
var G__12693 = cljs.core.rest.call(null,path);
obj = G__12692;
path = G__12693;
continue;
} else {
...
var _STAR_ = (function (accum,p__12694){
var vec__12695 = p__12694;
var bit = cljs.core.nth.call(null,vec__12695,(0),null);
var protocol = cljs.core.nth.call(null,vec__12695,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12698){
var vec__12699 = p__12698;
var ns = cljs.core.nth.call(null,vec__12699,(0),null);
var name = cljs.core.nth.call(null,vec__12699,(1),null);
var selector = cljs.core.nth.call(null,vec__12699,(2),null);
...
var post_process = (function (p__12703){
var vec__12704 = p__12703;
var munged_name = cljs.core.nth.call(null,vec__12704,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12704,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12702_SHARP_){
return (obj[cljs.core.first.call(null,p1__12702_SHARP_)]);
}),sorted_matches);
