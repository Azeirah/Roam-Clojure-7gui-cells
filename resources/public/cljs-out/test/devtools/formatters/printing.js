...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12735){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12736,G__12737,seq12735__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12741_SHARP_){
return (!((cljs.core.meta.call(null,p1__12741_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__12742__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12746){var _e__12460__auto__ = e12746;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e12748){var _e__12460__auto__ = e12748;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12750 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12751 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12751);

try{var map__12752 = opts;
...
var markup_db = cljs.core.get.call(null,map__12752__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12750);
}});
...
var temp__5718__auto___12757 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___12757)){
var managed_print_level_12758 = temp__5718__auto___12757;
var _STAR_print_level_STAR__orig_val__12755_12759 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12756_12760 = managed_print_level_12758;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12756_12760);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__12754_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__12754_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12755_12759);
}} else {
job_fn.call(null);
}
