window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=d20b66&fwbuild=test"};
...
document.write('<script>goog.require("cells.test_runner");</script>');
